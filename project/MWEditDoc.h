...
class CMWEditDoc : public CDocument {
  ...
  public:
	...
	CEsmRecord *CreateCopyINFO (CMWEditDoc* pDocument, CEsmDialogue* pDialRecord,
	...
	bool ExportSpellMerchant (CEsmNpc* pNpc, CEsmSpell* pSpell, CEsmSubCellRef* pCellRef,
	                           CGenFile& File);

	bool ExportSpellMerchant (CEsmNpc* pNpc, CEsmSpell* pSpell, CEsmSubCellRef* pCellRef,
	                           const int EffectID, CGenFile& File);
