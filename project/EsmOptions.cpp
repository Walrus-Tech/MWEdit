...
bool CEsmOptions::ReadFromRegistry(void) {
	...
	m_BackupSaves = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_BACKUPSAVES,
	                                     m_BackupSaves) != 0);
	m_AllowExtFuncs = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWEXTFUNCS,
	                                       m_AllowExtFuncs) != 0);
	m_StrictIDs = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_STRICTIDS,
	                                   m_StrictIDs) != 0);
	m_AllowBloodmoon = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWBLOODMOON,
	                                        m_AllowBloodmoon) != 0);
	m_AllowTribunal = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWTRIBUNAL,
	                                       m_AllowTribunal) != 0);
	/* Script options */
	m_ScriptWarnLevel = pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_WARNLEVEL,
	                                        m_ScriptWarnLevel);
	m_NoScriptFormat = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_NOSCRFORMAT,
	                                        m_NoScriptFormat) != 0);
	m_UseExtraFile = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_USEEXTRAFILE,
	                                      m_UseExtraFile) != 0);
	m_NoScriptPrompt = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_NOSCRPROMPT,
	                                        m_NoScriptPrompt) != 0);
	m_InitialIndentLevel = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT,
	                                            ESMSCR_REGENTRY_INITIALINDENTLEVEL, m_InitialIndentLevel) != 0);
	m_IndentCommentsMore = (pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT,
	                                            ESMSCR_REGENTRY_INDENTCOMMENTSMORE, m_IndentCommentsMore) != 0);
	m_ScriptFormatType = pApp->GetProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_SCRFORMAT,
	                                         m_ScriptFormatType);
	Buffer = pApp->GetProfileString(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_EXTRAFILE, m_ExtraFile);
	SetExtraFile(Buffer);
	Buffer = pApp->GetProfileString(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_SCRIPTINDENTSTRING,
...
bool CEsmOptions::WriteToRegistry(void) {
	...
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWEXTFUNCS,
	                                 m_AllowExtFuncs);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_STRICTIDS, m_StrictIDs);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWBLOODMOON,
	                                 m_AllowBloodmoon);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_ALLOWTRIBUNAL,
	                                 m_AllowTribunal);
	/* Script options */
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_WARNLEVEL,
	                                 m_ScriptWarnLevel);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_NOSCRPROMPT,
	                                 m_NoScriptPrompt);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_INITIALINDENTLEVEL,
	                                 m_InitialIndentLevel);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_INDENTCOMMENTSMORE,
	                                 m_IndentCommentsMore);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_NOSCRFORMAT,
	                                 m_NoScriptFormat);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_USEEXTRAFILE,
	                                 m_UseExtraFile);
	iResult &= pApp->WriteProfileInt(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_SCRFORMAT,
	                                 m_ScriptFormatType);
	iResult &= pApp->WriteProfileString(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_EXTRAFILE, m_ExtraFile);
	iResult &= pApp->WriteProfileString(ESMSCR_REGSEC_SCRIPT, ESMSCR_REGENTRY_SCRIPTINDENTSTRING,
	                                    m_ScriptIndentString);
	/* Script user format */
